package com.example.fostersoftsol01.luvoffers.Debenhams;
...
public class DebenhamsHome extends BaseActivity {

    private TextView tvOfferLink,tvDetails;
    private ImageView imgMenu,imgBack,imgDebenhamsLink;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setContentView(R.layout.activity_debenhams_home);

        getLayoutInflater().inflate(R.layout.activity_debenhams_home, frameLayout);
        ...
        btnOffers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DebenhamsHome.this, AccpetOffer.class));      }
        });

        btnLater.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                startActivity(new Intent(DebenhamsHome.this,MainActivity.class));
                finish();
            }
        });
