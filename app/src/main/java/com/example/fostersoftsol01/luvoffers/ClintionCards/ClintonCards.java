...
public class ClintonCards extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clinton_cards);
        ...
        btnLater.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //startActivity(new Intent(ClintonCards.this, GreggsHome.class));
                Toast.makeText(getApplicationContext(),"Under Development",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void prepareAlbums() {
        int[] covers = new int[]{
                ...
                R.drawable.mug_new};
//
        Album a = new Album("Gift Bags",1,covers[0]);
        albumList.add(a);

        a = new Album("Gift Bears", 8, covers[1]);
        albumList.add(a);

        a = new Album("Picture Frames", 11, covers[2]);
        albumList.add(a);
