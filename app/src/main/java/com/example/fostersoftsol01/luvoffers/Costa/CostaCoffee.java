...
import com.example.fostersoftsol01.luvoffers.GreggsBakery.GreggsBakery;
import com.example.fostersoftsol01.luvoffers.R;

import java.util.ArrayList;
import java.util.List;

public class CostaCoffee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_costa_coffee);
        ...
        btnOffers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               //startActivity(new Intent(ClintonCards.this, GreggsBakery.class));
    ...
    private void prepareAlbums() {
        int[] covers = new int[]{
                R.drawable.sandwishes_new,
                R.drawable.ecliar_new,
                R.drawable.chiken_new,
                R.drawable.cake_costa};
//
        Album a = new Album("Toasted Sandwiches",1,covers[0]);
        albumList.add(a);

        a = new Album("Chocolate Eclairs", 8, covers[1]);
        albumList.add(a);

        a = new Album("Croissants", 11, covers[2]);
        albumList.add(a);

        a = new Album("Carrot Cake", 12, covers[3]);
        albumList.add(a);
