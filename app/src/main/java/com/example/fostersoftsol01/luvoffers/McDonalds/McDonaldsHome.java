package com.example.fostersoftsol01.luvoffers.McDonalds;
...
public class McDonaldsHome extends BaseActivity {

    private TextView tvOfferLink;
    private ImageView imgMenu,imgBack,imgMcDLink;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setContentView(R.layout.activity_mc_donalds_home);

        getLayoutInflater().inflate(R.layout.activity_mc_donalds_home, frameLayout);
        ...
        btnOffers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(McDonaldsHome.this, AccpetOffer.class));    }
        });

        btnLater.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                startActivity(new Intent(McDonaldsHome.this,MainActivity.class));
                finish();
            }
        });
