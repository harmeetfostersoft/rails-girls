...
public class GreggsHome extends BaseActivity {

    private TextView tvOfferLink;
    private ImageView imgMenu,imgBack,imgClintionAnother;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.activity_greggs_home);

        getLayoutInflater().inflate(R.layout.activity_greggs_home, frameLayout);
        ...
        btnOffers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(GreggsHome.this, AccpetOffer.class));     }
        });

        btnLater.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                startActivity(new Intent(GreggsHome.this,MainActivity.class));
                finish();
            }
        });
