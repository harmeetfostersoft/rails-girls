...
public class NextProducts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_next_products);
...
//
        Album a = new Album("Tesco Apples",1,covers[0]);
        albumList.add(a);

        a = new Album("Tescos Oranges", 8, covers[1]);
        albumList.add(a);

        a = new Album("Tescos Pears", 11, covers[2]);
        albumList.add(a);

        a = new Album("Tescos Grapes", 12, covers[3]);
        albumList.add(a);
