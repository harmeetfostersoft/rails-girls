...
public class MsHome extends BaseActivity {


    private TextView tvOfferLink;
    private ImageView imgMenu,imgBack,imgMsLink;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_ms_home, frameLayout);
        ...
        btnOffers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MsHome.this, AccpetOffer.class));      }
        });

        btnLater.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                startActivity(new Intent(MsHome.this,MainActivity.class));
                finish();
            }
        });
