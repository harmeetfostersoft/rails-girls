...
public class McDonaldProducts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mc_donald_products);
...
//
        Album a = new Album("McFlurry",1,covers[0]);
        albumList.add(a);

        a = new Album("Fillet Fish", 8, covers[1]);
        albumList.add(a);

        a = new Album("Chicken Nuggets", 11, covers[2]);
        albumList.add(a);

        a = new Album("Chips", 12, covers[3]);
        albumList.add(a);
