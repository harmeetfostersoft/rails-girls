                ...
                switch (tilesContainer.indexOfChild(v)) {
                    case 0:
                        if (tilesContainer.getChildAt(0).getLayoutParams().height != firstChildHeight) {
                            ...
                            startActivity(new Intent(HomeActivity.this, GreggsHome.class));
...
//                            addFragmentToScreen(fragment);
                    ...
                    case 1:
                        if (tilesContainer.getChildAt(1).getLayoutParams().height != firstChildHeight) {
                            ...
                            {
                                startActivity(new Intent(HomeActivity.this, CostaHome.class));
                            }
                        break;
                    ...
                    case 2:
                        ...
                        {
                            startActivity(new Intent(HomeActivity.this, NextHome.class));
                        }
                        break;
                    ...
                    case 3:
                        ...
                        {
                            startActivity(new Intent(HomeActivity.this, McDonaldsHome.class));
                        }
                        break;
                    ...
                    case 4:
                        ...
                        {
                            startActivity(new Intent(HomeActivity.this, MsHome.class));
                        }
                        break;
                    case 5:
                        ...
                        {
                            startActivity(new Intent(HomeActivity.this, DebenhamsHome.class));
                        }
                        break;
                    case 6:
                        if (tilesContainer.getChildAt(6).getLayoutParams().height != firstChildHeight) {
                            downToUpScroll(HelperView.getCurrentView(), HelperView.getFollowingView());
                        }
                        else
                        {
                            startActivity(new Intent(HomeActivity.this, ClintionHome.class));
                        }
                        break;
                    case 7:
                        if (tilesContainer.getChildAt(7).getLayoutParams().height != firstChildHeight) {
                            downToUpScroll(HelperView.getCurrentView(), HelperView.getFollowingView());
                        }
                        else
                        {
                            startActivity(new Intent(HomeActivity.this, TescoHome.class));
                        }
                        break;
                }
            }
