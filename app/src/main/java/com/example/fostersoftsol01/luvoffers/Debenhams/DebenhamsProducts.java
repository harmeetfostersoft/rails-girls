...
public class DebenhamsProducts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_debenhams_products);
...
//
        Album a = new Album("Jackets",1,covers[0]);
        albumList.add(a);

        a = new Album("Shoes & Boots", 8, covers[1]);
        albumList.add(a);

        a = new Album("Waistecoats", 11, covers[2]);
        albumList.add(a);

        a = new Album("Mens Shorts", 12, covers[3]);
        albumList.add(a);
